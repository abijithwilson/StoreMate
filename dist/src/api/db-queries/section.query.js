...
exports.fetchSectionVisitsQuery = exports.fetchProductDefaults = exports.fetchProductFiltersQuery = exports.unAssignProductFromWishlistQuery = exports.fetchWishlistProductsQuery = exports.fetchSectionWiseOfferListQuery = exports.fetchSectionWiseCategoryListQuery = exports.unAssignSection = exports.ProductsNotAssignedToAnySection = exports.getSectionAndSectionNotListedInStoreQuery = exports.sectionUnderStoreDropdownQuery = exports.fetchDetailsOfAProductInASection = exports.assignProductSection = exports.sectionWiseProductUnassignQuery = exports.assignSectionQuery = exports.listStoreWiseSectionsQuery = void 0;
const K = require("../../shared/constants");
exports.listStoreWiseSectionsQuery = `with fetchCategories as(
  select
  tssm.section_id,
...
const assignSectionQuery = (section_id) => `
insert into t_store_section_map (store_id,section_id)
values ($1,unnest(array[${section_id}])) returning store_id
`;
exports.assignSectionQuery = assignSectionQuery;
exports.sectionWiseProductUnassignQuery = `
...
`;
const assignProductSection = (productId) => {
    let queryValue = 3;
...
exports.assignProductSection = assignProductSection;
exports.fetchDetailsOfAProductInASection = `SELECT 
mp.id AS product_id,
...
exports.sectionUnderStoreDropdownQuery = `
select 
tssm.section_id ,
ms.section_name 
from t_store_section_map tssm 
...
`;
const getSectionAndSectionNotListedInStoreQuery = (limit, offset, sortField, sortOrder) => `
select 
section_id,
section_name ,
count(*) over()
...
`;
exports.getSectionAndSectionNotListedInStoreQuery = getSectionAndSectionNotListedInStoreQuery;
exports.ProductsNotAssignedToAnySection = `
...
with unassignSectionFromProduct as(
   ...
   returning tssm.id
`;
const fetchSectionWiseCategoryListQuery = (limit, offset) => `
select 
...
${offset ? `offset ${offset}` : ''}
`;
exports.fetchSectionWiseCategoryListQuery = fetchSectionWiseCategoryListQuery;
const fetchSectionWiseOfferListQuery = (limit, offset) => `select
  mo.offer_id ,
  mo.image,
  mo.offer_title,
  mo.description,
...
${offset ? `offset ${offset}` : ''}
`;
exports.fetchSectionWiseOfferListQuery = fetchSectionWiseOfferListQuery;
const fetchWishlistProductsQuery = (filterCategory, filterColour, fiterSize) => {
    const dataValue = [];
    let queryValue = 4;
    const filterQuery = [];
    if (filterCategory) {
...
exports.fetchWishlistProductsQuery = fetchWishlistProductsQuery;
exports.unAssignProductFromWishlistQuery = `delete from t_wishlist_user twu
where twu.user_id = $1 and twu.store_id = $2
and twu.product_id = $3
returning twu.id `;
const fetchProductFiltersQuery = (filterCategory, wishlist) => {
    let i = 3;
    const dataValue = [];
    if (filterCategory) {
        dataValue.push(...JSON.parse(filterCategory));
...
exports.fetchProductFiltersQuery = fetchProductFiltersQuery;
exports.fetchProductDefaults = `select array(
...
const fetchSectionVisitsQuery = (limit, offset) => `with fetchSectionCount as (select 
  tsv.section_id,
  ms2.section_name,
  ...
  ${limit ? `limit ${limit}` : ''}
  ${offset ? `offset ${offset}` : ''}`;
exports.fetchSectionVisitsQuery = fetchSectionVisitsQuery;
//# sourceMappingURL=section.query.js.map