...
exports.userExitQuery = exports.updateUserRewardQuery = exports.fetchAddressDetailQuery = void 0;
exports.fetchAddressDetailQuery = `
select 
ma.id ,
ma.address ,
ma.country_id ,
...
where ma.user_id = $1
`;
exports.updateUserRewardQuery = `with selectStoreId as 
