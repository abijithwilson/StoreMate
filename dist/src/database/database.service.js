...
const db_exception_error_1 = require("../error/db-exception.error");
...
let DatabaseService = DatabaseService_1 = class DatabaseService {
    ...
    runQuery(query, params, type) {
        const start = Date.now();
        return (0, rxjs_1.from)(this.pool.query(query, params)).pipe((0, operators_1.map)((qRes) => qRes.rows
