...
exports.PermissionCheckGuard = void 0;
const common_1 = require("@nestjs/common");
const core_1 = require("@nestjs/core");
const passport_1 = require("@nestjs/passport");
let PermissionCheckGuard = class PermissionCheckGuard extends (0, passport_1.AuthGuard)('permission-check-strategy') {
...
PermissionCheckGuard = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [core_1.Reflector])
], PermissionCheckGuard);
exports.PermissionCheckGuard = PermissionCheckGuard;
//# sourceMappingURL=permission-check.guard.js.map