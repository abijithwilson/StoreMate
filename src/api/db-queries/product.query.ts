...
export const createProductSku = (values) => `
WITH insertSkuValue(
    sku_unique_id,
    colour_id,
    size_id,
...
export const updateProductSku = (values) => `
WITH insertSkuValue(
    id,sku_unique_id,
...
export const fetchSingleProductSkuDetailsQuery = `SELECT 
...
export const listAllProductsQuery = `select m_product.id,
...
export const fetchProductOffersQuery = (
  sortField,
  sortOrder,
  limit,
  offset
...
export const fetchStoreWiseProductSkusQuery = `
select 
m_product.id AS product_id,
m_product.product_name AS name,
c.name AS category,
...
export const bulkProductUploadQuery = (file: CsvProductDto, id: any) => {
...
export const fetchProductWiseOffersQuery = (
  sortField,
  sortOrder,
  limit,
  offset
...
export const skuFetchQuery = (productListSet) => {
  return `select
...
export const skuUpdateQuery = (idList) => `update m_sku_table 
