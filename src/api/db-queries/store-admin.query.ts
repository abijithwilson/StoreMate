...
export const fetchAssignedStores = `
SELECT 
...
export const fetchStoreAdminProfile = `
select  
m_admin.admin_id,
m_admin.first_name,
m_admin.last_name,
...
export const fetchSectionWiseProductsQuery = (
  filterCategory,
  sortField,
  sortOrder,
  limit,
...
export const BeaconFetchQuery = (limit: number, offset: number) => `
select 
mb.beacon_id ,
mb.name as name,
mb.major_id ,
...
${offset ? `offset ${offset}` : ''}
`;
export const unAssignBeaconQuery = `
  update m_beacon 
  set section_id = NULL,
...
export const fetchVisitorsCount = `
select 
...
export const assignBeaconQuery = (beaconId) => {
  let queryValue = 3;
...
export const fetchStoreDashboardDataQuery = `
